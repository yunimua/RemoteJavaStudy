		...
		*/
		...
		/*
			# 변수의 작명 규칙 ( 권장 사항 )
				...
				(1) 두 단어 이상을 이어붙인 변수 명을 사용할 때 _를 활용한다 (snake_case)
				ex : apple_count, minsu_age, minsu_math_score
		
				(2) 두 단어 이상을 이어붙인 변수 명을 사용할 때 대문자를 활용한다 (camelCase)
				ex : appleCount, minsuAge, minsuMathScore
		
				(3) 변수 명 첫 글자는 소문자를 사용한다
		
				(4) 클래스 명 첫 글자는 대문자를 사용한다
				...
				# 필수적인 변수의 작명 규칙 (안키지면 에러)
		
				(1) 변수의 첫 번쨰 글자는 숫자가 될 수 없다
				ex : 1st, 2nd, 4apple (XXX)
